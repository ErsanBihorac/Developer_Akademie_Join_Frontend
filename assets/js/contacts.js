...
async function deleteContact(index) {
    ...
    await fetch(`http://localhost:8000/api/contacts/${contacts[index].id}/`, {
        method: 'DELETE',
        headers: {
    ...
    closeOverlayAfterDeleting();
}

function closeOverlayAfterDeleting(){
...
async function addContact() {
    ...
    const response = await fetch('http://localhost:8000/api/contacts/', {
        ...
        body: JSON.stringify({
            name: document.getElementById('input-name-addcontact').value,
            email: document.getElementById('input-email-addcontact').value,
            phone: document.getElementById('input-phone-addcontact').value,
            firstLetter: idLetter(document.getElementById('input-name-addcontact').value),
            colorId: randomColor(),
        }),
    });
...
async function loadContacts() {
    ...
    if (response.ok) {
        ...
        console.error('Error loading Contact:', response.statusText);
    }
}
...
function editContact(index) {
    ...
    document.getElementById('EditContactFirstLettersColor').classList.add(`color${contacts[index]['color_id']}`);
    document.getElementById('EditContactFirstLettersColor').classList.add('editContactLetter');
    document.getElementById('EditContactFirstLettersColor').innerHTML = `${contacts[index]['first_letter']}`;
}
...
function contactDetailsTemplate(index) {
    ...
    <div class="details-upper-part">
      <div class="details-pfp color${contacts[index]['color_id']}">${contacts[index]['first_letter']}  </div>
      <div class="gap">
